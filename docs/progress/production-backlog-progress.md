...
| 004 | Verified in PR | `pending` | #19 | RED contract proven in CI run 259; final CI run 268 passed contracts, tests, typecheck, build, binaries, distribution, clean install, Gemini validation, and residue checks |
