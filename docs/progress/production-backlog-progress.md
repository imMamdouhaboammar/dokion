...
| 006 | In review | `pending` | #23 | RED behavior proven in CI runs 290 and 293; registry type boundaries corrected after CI run 302; final full-suite verification pending |
