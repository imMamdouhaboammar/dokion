...
| 003 | Verified in PR | `pending` | #17 | RED contract proven in CI run 244; final CI run 253 passed contracts, tests, typecheck, build, binaries, distribution, clean install, Gemini validation, and residue checks |
