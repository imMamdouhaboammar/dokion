...
| 006 | Merged | `f38c3b9fd66919725071bbc75524ad5bcae9b5e7` | #23 | RED behavior proven in CI runs 290 and 293; type boundaries corrected after CI runs 302 and 307; final CI run 311 passed contracts, tests, typecheck, build, binaries, distribution, clean install, Gemini validation, and residue checks |
| 007 | Merged | `b54f3e0f8cd45560c4933a733bb2a6369d4a0e2b` | #25 | RED contract proven in CI run 315; final CI run 325 passed contracts, tests, typecheck, build, binaries, distribution, clean install, Gemini validation, and residue checks |
| 008 | Verified in PR | `pending` | #27 | RED contract proven in CI run 329; final CI run 336 passed contracts, tests, typecheck, build, binaries, distribution, clean install, Gemini validation, and residue checks |
