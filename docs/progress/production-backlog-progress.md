...
| 007 | Verified in PR | `pending` | #25 | RED contract proven in CI run 315; final CI run 323 passed contracts, tests, typecheck, build, binaries, distribution, clean install, Gemini validation, and residue checks |
