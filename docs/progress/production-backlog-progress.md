...
| 005 | Verified in PR | `pending` | #21 | RED contract proven in CI run 274; final CI run 282 passed contracts, tests, typecheck, build, binaries, distribution, clean install, Gemini validation, and residue checks |
