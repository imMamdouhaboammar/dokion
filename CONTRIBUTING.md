...
Dokion is a security-sensitive local CLI. Contributions must preserve the user-authority model, evidence requirements, exact rollback behavior, explicit platform degradations, and Bun-only repository workflow.
