...
[![Runtime: M0-M4](https://img.shields.io/badge/runtime-M0--M4%20implemented-2EA44F.svg?style=flat-square)](docs/superpowers/plans/2026-07-25-m4-adversarial-validation.md)
...
Dokion is now an executable Bun CLI, not a specification-only repository.
...
- M5: canonical cross-agent adapters and honest platform-degradation records
- M6: marketplace packaging, strict validation, clean-install reproduction, and release automation
...
A historical unchanged test no longer satisfies `require_regression_test`.
...
The valid completion statement is scoped to the user-configured gates, the tested commit, the stored evidence, and the limitations recorded in `HARDENING.md`.
